...
- **交互体验**：检索式页面支持六库标签页与一键复制；候选清单支持本地搜索、验证状态/OA/年份筛选和表头排序；工作台右上角可一键切换中文/英文界面，范围卡与使用说明正文、页面目录和固定界面同步切换。检索式、关键词清单、排除词、文献题名、作者、期刊、DOI 等科研数据保持原样。所有功能均无 CDN、无外部网络依赖，关闭 JavaScript 后主 Markdown 原文仍完整可读。

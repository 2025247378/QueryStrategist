...
const I18N={
zh:{
page_index_title:'检索策略包',page_scope_card_title:'研究范围',page_query_pack_title:'多平台检索式',page_candidate_list_title:'文献候选清单',page_usage_guide_title:'检索使用说明',
...
scope_title:'研究范围',scope_desc:'确认对象、技术、任务、排除项与检索边界。',queries_title:'多平台检索式',queries_desc:'按数据库查看、复制并验证检索式。',candidates_title:'文献候选清单',candidates_desc:'搜索、筛选和排序 API 收割的待核验文献。',guide_title:'检索使用说明',guide_desc:'查看各平台填入位置以及调宽、调窄方法。',
database_tabs:'数据库',variant_tabs:'检索式层级',variant_a0:'A0 高召回',variant_a1:'A1 推荐起步',variant_b:'B 精准检索',variant_review:'综述补充',recommended:'推荐',query_fallback:'检索式 {number}',copy_query:'复制检索式',copy:'复制',copied:'已复制',copy_failed:'复制失败',qa_notice:'最终仍以数据库官网解析和命中结果为准。',document_fallback:'检索策略包',
...
header_title:'题名',header_authors:'作者',header_year:'年份',header_source:'来源',header_doi:'DOI',header_status:'验证状态',header_oa:'OA 状态',header_abstract:'摘要',header_keywords:'关键词'
},
en:{
page_index_title:'Search Strategy Package',page_scope_card_title:'Research Scope',page_query_pack_title:'Multi-Platform Queries',page_candidate_list_title:'Candidate Records',page_usage_guide_title:'Search Guide',
skip_main:'Skip to main content',nav_overview:'Overview',nav_scope_card:'Scope Card',nav_query_pack:'Queries',nav_candidate_list:'Candidates',nav_usage_guide:'Guide',primary_nav:'Primary navigation',print_page:'Print this page',switch_english:'Switch interface to English',switch_chinese:'Switch interface to Chinese',
...
scope_title:'Research Scope',scope_desc:'Confirm the subject, methods, tasks, exclusions, and search boundaries.',queries_title:'Multi-Platform Queries',queries_desc:'Review, copy, and validate queries by database.',candidates_title:'Candidate Records',candidates_desc:'Search, filter, and sort API-harvested records awaiting verification.',guide_title:'Search Guide',guide_desc:'See where to paste each query and how to broaden or narrow it.',
database_tabs:'Databases',variant_tabs:'Query levels',variant_a0:'A0 High Recall',variant_a1:'A1 Recommended',variant_b:'B Precision',variant_review:'Review Supplement',recommended:'Recommended',query_fallback:'Query {number}',copy_query:'Copy query',copy:'Copy',copied:'Copied',copy_failed:'Copy failed',qa_notice:'Always confirm parsing and result counts on the official database website.',document_fallback:'Search Strategy Package',
...
header_title:'Title',header_authors:'Authors',header_year:'Year',header_source:'Source',header_doi:'DOI',header_status:'Verification Status',header_oa:'OA Status',header_abstract:'Abstract',header_keywords:'Keywords'
}};
...
function variantKey(text){const value=text.trim();if(/^A0\b/i.test(value))return'variant_a0';if(/^A1\b/i.test(value))return'variant_a1';if(/^B\b/i.test(value))return'variant_b';if(/^E\b/i.test(value)||/review|综述/i.test(value))return'variant_review';return''}

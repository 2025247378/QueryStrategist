...
1. **意图 → 策略的结构化转化**：Scope Definer 通过结构化提问把模糊研究方向收敛为「三级关键词 + 排除项」，再机械化为 6 库高级检索式——杜绝靠直觉拼关键词。
...
- **`scope_card.md` — 范围界定卡**：三级关键词体系（Tier1 对象 / Tier2 技术 / Tier3 应用）+ 排除项 + 写作类型 + 策略权重（查全/查准/新颖性）。
